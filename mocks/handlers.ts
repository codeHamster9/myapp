...
export const handlers = [
  ...
  http.get('http://localhost:3000/api/items', async () => {
    const data: Item[] = [
      {
        id: 1,
        title: 'Mountain Trek',
      ...
      },
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1520454974749-611b7248ffdb?auto=format&fit=crop&q=80&w=400',
      },
      {
        id: 3,
        title: 'City Explorer',
      ...
      },
      {
        ...
        category: 'Adventure',
        description:
          'Thrilling dune bashing and desert camping under the stars',
        imageUrl:
          'https://images.unsplash.com/photo-1542401886-65d6c61db217?auto=format&fit=crop&q=80&w=400',
      },
      {
        id: 7,
        title: 'Yoga Retreat',
        category: 'Wellness',
        description:
          'Rejuvenating yoga sessions in a peaceful mountain setting',
        imageUrl:
      ...
      },
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1522163182402-834f871fd851?auto=format&fit=crop&q=80&w=400',
      },
      {
        id: 13,
        title: 'Cooking Class',
